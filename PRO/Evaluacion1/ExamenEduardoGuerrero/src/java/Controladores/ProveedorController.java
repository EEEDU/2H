...
public class ProveedorController implements Serializable {
    ...
    private List<Proveedorcomponente> listaProveedorescomponente;
    ...
    public List<Proveedorcomponente> getListaProveedorescomponente() {
        return listaProveedorescomponente;
    }

    public void setListaProveedorescomponente(List<Proveedorcomponente> listaProveedorescomponente) {
        this.listaProveedorescomponente = listaProveedorescomponente;
    }
    ...
    public SelectItem[] getItemsAvailableSelectOne() {
        return getSelectItems(ejbFacade.proveedores_ordenados(), true);
    }
    ...
    public static SelectItem[] getSelectItems(List<Proveedor> entities, boolean selectOne) {
        ...
        int i = 0;
        if (selectOne) {
            items[0] = new SelectItem("", "Seleccione un proveedor");
            i++;
        }
        for (Proveedor x : entities) {
            items[i++] = new SelectItem(x, x.getNomProveedor());
        }
        return items;
    }
    
    public void cargarProveedorComponente(){
        listaProveedorescomponente = ejbFacade.proveedor_por_componente(componente);
    }
}
