...
public class PremiosController implements Serializable {
    ...
    private List<AutorPremio> listaPA;
    ...
    public List<AutorPremio> getListaPA() {
        return listaPA;
    }

    public void setListaPA(List<AutorPremio> listaPA) {
    ...
    public SelectItem[] getItemsAvailableSelectOne() {
        return getSelectItems(ejbFacade.premios_orden(), true);
    }

    public SelectItem[] getItemsAvailableSelectOneAutor() {
        return getSelectItems(ejbFacade.premios_autor(), true);
    }
    public SelectItem[] getItemsAvailableSelectOneLibro() {
        return getSelectItems(ejbFacade.premios_libro(), true);
    }
  ...
  public static SelectItem[] getSelectItems(List<Premios> entities, boolean selectOne) {
    ...
    public void cargarPremiosAutores(){
        listaPA = ejbFacade.premio_por_autor(autor);
    }
