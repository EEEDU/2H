...
class coche(models.Model):
    ...
    consumo = fields.Float(string='Consumo', default=0.0, help='Consumo promedio cada 100 kilometros')
...
class mantenimiento(models.Model):
    ...
    fecha = fields.Char(string='Fecha', required=True, default=fields.date.today())
    tipo = fields.Selection(string='Tipo', selection=[('l', 'Lavar'), ('r', 'Revision'), ('m', 'Mecanica'), ('p', 'Pintura')], default='l')
    coste = fields.Float(string='Coste', help='Coste total del mantenimiento')
